...
void SatelliteSim::recordCompute(VkCommandBuffer cmd, VulkanContext &ctx, float dt)
{
    ...
    if (cloudParamsMapped)
    {
        ...
        cp.terrainErosionStrength = terrainErosionStrength;
        cp.terrainErosionAmplitudeM = terrainErosionAmplitudeM;
        cp.terrainErosionFreq = 1.0f / glm::max(terrainErosionFeatureSizeM, 1.0f);
        cp.terrainErosionSlopeLo = terrainErosionSlopeLo;
        cp.terrainErosionSlopeHi = terrainErosionSlopeHi;
        cp.terrainErosionBranchStrength = terrainErosionBranchStrength;
        cp.terrainErosionFadeStartM = terrainErosionFadeStartM;
        cp.terrainErosionFadeEndM = terrainErosionFadeEndM;
        cp.terrainStepTargetM = terrainStepTargetM;
        cp.terrainStepsMin = terrainStepsMin;
        cp.terrainStepsMax = terrainStepsMax;
        cp.terrainStepPow = terrainStepPow;
        cp.terrainHorizonBlendWidth = terrainHorizonBlendWidth;
        cp.terrainDebugElevZebraM = terrainDebugElevZebraM;
        cp.terrainDebugDistZebraM = terrainDebugDistZebraM;
